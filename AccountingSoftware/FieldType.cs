...
namespace AccountingSoftware
{
	...
	public class FieldType(string confTypeName, string viewTypeName)
	{
		...
		/// </summary>
		/// <returns></returns>
		public override string ToString() => ViewTypeName;

		/// <summary>
		/// Типи але у вигляді словника
		/// </summary>
		/// <returns>Заповнений словник</returns>
		public static Dictionary<string, string> GetFieldTypes_Dict() =>
			DefaultList().ToDictionary(item => item.ConfTypeName, item => item.ViewTypeName);
