...
namespace AccountingSoftware
{
    ...
    public interface IDataBase
    {
        ...
        ValueTask SpetialTableObjectVersionsHistoryAdd(Guid version_id, Guid user_uid, UuidAndText obj, Dictionary<string, object> fieldValue, char operation, string info = "");
        ...
        ValueTask SpetialTableTablePartVersionsHistoryAdd(Guid version_id, Guid user_uid, Dictionary<string, object> fieldValue);
