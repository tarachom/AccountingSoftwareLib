...
public partial class ConfiguratorDirectoriesTree(Configuration conf, Action<string, string>? activate)
{
    ...
    public Box Fill()
    {
        ...
        foreach (ConfigurationDirectories directories in Conf.Directories.Values)
        ...
        //Дерево
        {
            ...
            var column = ColumnViewColumn.New("Довідники", factory);
