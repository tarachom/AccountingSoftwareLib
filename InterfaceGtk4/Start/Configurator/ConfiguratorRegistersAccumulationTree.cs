...
public partial class ConfiguratorRegistersAccumulationTree(Configuration conf, Action<string, string>? activate)
{
    ...
    public Box Fill()
    {
        ...
        //Дерево
        {
            ...
            var column = ColumnViewColumn.New("Регістри накопичення", factory);
