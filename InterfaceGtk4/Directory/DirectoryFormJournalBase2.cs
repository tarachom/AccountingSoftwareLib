...
/// </summary>
[GObject.Subclass<FormJournal2>]
public partial class DirectoryFormJournalBase2 : FormJournal2
{
    /// <summary>
    ...
    /// <param name="uniqueID">Ід об'єкту</param>
    /// <returns></returns>
    protected virtual async ValueTask<UniqueID?> Copy(UniqueID uniqueID) { return await ValueTask.FromResult(UniqueID.NewEmpty()); }
