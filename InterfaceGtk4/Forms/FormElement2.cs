...
public partial class FormElement2 : Form2
{
    /// <summary>
    /// Об'єкт який привязується до форми
    /// </summary>
    protected AccountingSoftware.Object? Element { get; set; }
    ...
    /// Збереження
    /// </summary>
    protected virtual async ValueTask<bool> Save() { return await ValueTask.FromResult(true); }
